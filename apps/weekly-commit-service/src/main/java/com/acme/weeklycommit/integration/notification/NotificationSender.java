 ...
 * (ADR-0002). Separated from {@link com.acme.weeklycommit.service.statemachine.NotificationDispatcher}
 * so the "defer until commit" concern and the "actually send it" concern can evolve independently.
 *
